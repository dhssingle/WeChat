...
using WeChat.MiniProgram.Models.Requests.Auth;
using WeChat.MiniProgram.Models.Responses.Auth;
...
namespace WeChat.MiniProgram.Services
{
    public class AuthService
    {
        ...
        public AuthService(MiniProgramClient client)
        {
            _client = client;
        }
        /// <summary>
        ...
        {
            return await _client.SendAsync<Code2SessionResponse>(request, false);
        }
        /// <summary>
